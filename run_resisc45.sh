...
python main.py --cfg configs/swin/swin_tiny_patch4_window7_224_resisc45.yaml --resume /afs/ece.cmu.edu/usr/ashwinve/Public/output/swin_tiny_patch4_window7_224_resisc45/default/L3_LORA_Epochs3.pth --data-path ./data/RESISC45/ --zip --cache-mode no --output /afs/ece.cmu.edu/usr/ashwinve/Public/output/
